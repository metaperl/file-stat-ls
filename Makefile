...
#     AUTHOR => q[=head2 Original Author, Terrence Brannon]
#     BUILD_REQUIRES => {  }
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  README.pod $(INST_MAN3DIR)/File::Stat::README.$(MAN3EXT) \
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>=head2 Original Author, Terrence Brannon</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  README.pod $(INST_LIB)/File/Stat/README.pod \
